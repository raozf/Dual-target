...
from utils import  random_select_points, shift_point_cloud, jitter_point_cloud, \
    ...
    transform, random_crop, shuffle_pc, random_scale_point_cloud, flip_pc,generate_random_rotation_matrix1, generate_random_tranlation_vector1
...
#        keep1 = np.random.uniform(0.50, 0.60)
        ...
        if self.split != 'train':
            ...
            R1, t1 = generate_random_rotation_matrix(), generate_random_tranlation_vector()
