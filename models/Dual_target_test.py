#This file is for test, and there is only one source point cloud in the forward propagation
import copy
import numpy as np
...
from models import InitModule2, AMPRModule, gather_points, weighted_icp


class Dual_target2(nn.Module):
    def __init__(self, args):
        super(Dual_target2, self).__init__()
        self.N1 = args.test_N1
        self.use_ppf = args.use_ppf
        self.cg= InitModule2(in_dim=3, gn=True)
        self.tfmr = AMPRModule(args)
